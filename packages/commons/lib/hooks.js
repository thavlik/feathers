...
exports.SKIP = createSymbol('__feathersSkipHooks');
exports.ACTIVATE_HOOKS = createSymbol('__feathersActivateHooks');
exports.createHookObject = function (method, data = {}) {
    const hook = {};
...
function processHooks(hooks, initialHookObject) {
    ...
    const promise = hooks.reduce((promise, fn) => {
        ...
        if (hook.length === 2) { // function(hook, next)
            promise = promise.then(hookObject => hookObject === exports.SKIP ? exports.SKIP : new Promise((resolve, reject) => {
                hook(hookObject, (error, result) => error ? reject(error) : resolve(result));
            }));
        }
        else { // function(hook)
            promise = promise.then(hookObject => hookObject === exports.SKIP ? exports.SKIP : hook(hookObject));
        }
...
exports.default = {
    SKIP: exports.SKIP,
    ACTIVATE_HOOKS: exports.ACTIVATE_HOOKS,
    createHookObject: exports.createHookObject,
